...
export const EN: Record<string, string> = {
  ...
  "settings.title.desc": "Print a title (the note's name) at the top. Skipped when the note already starts with its own heading — otherwise the same words would appear twice on page one.",
...
export const DE: Record<string, string> = {
  ...
  "settings.title.desc": "Druckt oben einen Titel (den Namen der Notiz). Entfällt, wenn die Notiz schon mit einer eigenen Überschrift beginnt — sonst stünde dasselbe zweimal auf Seite eins.",
